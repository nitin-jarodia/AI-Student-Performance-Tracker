  ...
  return (
    <div className="animate-fade-in mx-auto max-w-7xl space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Report builder</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Compose modular report blocks, preview, print to PDF.</p>
        </div>
